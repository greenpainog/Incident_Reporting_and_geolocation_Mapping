...
$query = "SELECT * FROM policetweets WHERE id='$id'";
...
<body >
    ...
    <div class="w3-top">
        <div class="w3-bar w3-black w3-card navbar">
            <a href="data.php" class="w3-bar-item w3-button w3-padding-large w3-black" class="page-link"><i class="fa fa-arrow-left"></i> Database Page</i></a>
            <div class="w3-bar-item w3-padding-large w3-black navbar-item" style="margin-left: 50px;">NATIONAL POLICE DEPARTMENT</div>
            <a href="map.php" class="w3-bar-item w3-button w3-padding-large w3-black"><i class="fa fa-map-marker"></i> Event map</a>
        </div>
    </div>

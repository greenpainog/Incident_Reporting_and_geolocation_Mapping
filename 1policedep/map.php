...
<head>
    ...
    <style>
        ...
        body {
            background-color: #2196F3; /* Set background color of the page */
...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card navbar">
    ...
    <div class="w3-bar-item w3-padding-large w3-black navbar-item"style="margin-right: 230px;">NATIONAL POLICE DEPARTMENT</div>

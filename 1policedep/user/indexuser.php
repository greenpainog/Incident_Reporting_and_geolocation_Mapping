...
if (isset($_POST["submit"])) {
    ...
    $max_id_query = "SELECT MAX(id) AS max_id FROM user_reports";
    ...
    $query = "INSERT INTO user_reports (id, created_at, description, category, location, latitude, longitude, attachments)
...
<div class="w3-top">
    <div class="w3-bar w3-black w3-card navbar">
        <a href="../index.php" class="w3-bar-item w3-button w3-padding-large w3-black"><i class="fa fa-arrow-left"> Home Page</i></a>
        <div class="w3-bar-item w3-padding-large w3-black navbar-item" style="margin-left: 50px;">NATIONAL POLICE DEPARTMENT</div>
        <a href="datauser.php" class="w3-bar-item w3-button w3-padding-large w3-black"><i class="fa fa-database"></i> Database Page</a>
    </div>
</div>
<br>
...
<div class="w3-row-padding w3-padding-64 w3-container">
    <div class="w3-content">
        <div class="w3-twothird">
            ...
            Reporting a live event to the police department is crucial for ensuring timely and effective law enforcement response.
             This process requires providing thorough and precise details about the incident. 
             Make sure to specify the event's category, such as illegal parking, suspicious noises, a stolen vehicle, a suspicious person, or road accidents. 
             ...
             By carefully filling out this information, individuals help law enforcement respond promptly and appropriately to the situation. 
              Whether it's a minor disturbance or a major incident, accurate reporting plays a vital role in maintaining public safety and order.
    </div>

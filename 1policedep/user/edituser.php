...
$query = "SELECT * FROM user_reports WHERE id='$id'";
...
if (isset($_POST["Update"])) {
    ...
    if (mysqli_query($conn, $query)) {
        ...
        header("Location: datauser.php?id=$id");
        exit;
...
<div class="w3-top">
    <div class="w3-bar w3-black w3-card navbar">
        <a href="datauser.php" class="w3-bar-item w3-button w3-padding-large w3-black"><i class="fa fa-arrow-left"></i> Database Page</a>
...
<div class="white-background">
    ...
    <form method="post" action="edituser.php?id=<?php echo $row['id']; ?>" class="form-container" enctype="multipart/form-data">

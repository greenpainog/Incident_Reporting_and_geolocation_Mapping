...
if (isset($_POST["submit"])) {
    ...
    $max_id_query = "SELECT MAX(id) AS max_id FROM firetweets";
    ...
    $query = "INSERT INTO firetweets (id, created_at, plain_text, category, spacy_woi, latitude, longitude)
...
<head>
    ...
    <style>
        ...
        .custom-bg-red {
            background-color: #FBCEB1; /* Set your desired background color */
        }
...
<body background-color="#FBCEB1">

<div class="w3-top">
    <div class="w3-bar w3-black w3-card navbar">
        <a href="../startpage.php" class="w3-bar-item w3-button w3-padding-large w3-black"><i class="fa fa-home"> Home Page</i></a>
        <div class="w3-bar-item w3-padding-large w3-black navbar-item" >NATIONAL FIRE DEPARTMENT</div>
        <a href="datafire.php" class="w3-bar-item w3-button w3-padding-large w3-black"><i class="fa fa-database"></i> Database Page</a>
    </div>
</div>
<br>
<header class="w3-container w3-red w3-center report-event">
    ...
    Report it now!</h3>
    <br>
    <a href="user/indexuserfire.php" class="w3-bar-item w3-button w3-padding-large w3-black"><i class="fa fa-circle red-dot-icon"></i> Report live event</a></div>
</header>
...
<div class="w3-row-padding w3-padding-64 w3-container ">
    <div class="w3-content custom-bg-red">
        <div class="w3-twothird">
            ...
            <p class="w3-text-grey">Reporting an event to the fire department requires providing thorough and precise details about the incident.
                 ...
                 By carefully filling out this information, individuals ensure that the fire department can respond promptly and appropriately to the situation.
                  Whether it's a fire, gas leak, chemical spill, or any other hazardous situation, accurate reporting plays a crucial role in maintaining public safety and minimizing damage.</p>
        </div>
